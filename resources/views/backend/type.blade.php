<x-backendtemplate>
    ...
    <div class="col-12 col-xl-8 mb-4">
        <h3 class="font-weight-bold"> Type </h3>
    </div>
            ...
            <div class="card-body">
                ...
                <form class=" row">
                    <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12">
                        ...
                        <input type="text" class="form-control mb-2 mr-sm-2" id="inputName" name="name" placeholder="e.g 2D, 3D">
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('master.getlistTypes') }}",
                columns: [
