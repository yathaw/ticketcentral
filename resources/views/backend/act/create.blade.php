    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title d-inline-block"> Create New </h4>
                ...
                <form action="{{ route('master.act.store') }}" method="POST" enctype="multipart/form-data" class="form-sample">
                @csrf 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @if($errors->first('name')) is-invalid @endif" name="name" value="{{ old('name') }}" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" id="membershipRadios1" value="Male" @if(old('gender') == 'Male') checked @endif>
                                            Male
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" id="membershipRadios2" value="Female" @if(old('gender') == 'Female') checked @endif>
                                            Female
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="date" placeholder="dd/mm/yyyy" name="dob" value="{{ old('dob') }}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" placeholder="e.g Yangon" name="pob" value="{{ old('pob') }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    ...
                                    <div class="col-12">
                                        <img id="image" width="250" class="d-block mt-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-11">
                                    <select class="form-control" name="type">
                                        <option value="Actor" @if(old('type') == 'Actor') selected @endif >Actor</option>
                                        <option value="Actress" @if(old('type') == 'Actress') selected @endif>Actress</option>
                                        <option value="Director" @if(old('type') == 'Director') selected @endif>Director</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <button type="submit" class="btn btn-custom mr-2">Save</button>
